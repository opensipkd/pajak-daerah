...
class range_thn extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['faction'] = active_module_url('range_thn/simpan');
        $data['current'] = 'stts';

        $this->load->view('range_thnv', $data);
    }
    ...
    public function cari()
    {
        ...
        if ($range1 && $result = $this->sppt_model->get_by_nop($range1)) {
            $output = array(
                'found' => 1,
                //'sEcho' => intval($sEcho),
