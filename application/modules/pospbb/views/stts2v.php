...
<?=str_repeat(' ',14) . str_pad(date('d/m/Y',strtotime($tgl_pembayaran_sppt)),14," ",STR_PAD_RIGHT).str_pad(number_format($luas_bumi_sppt,0,',','.'),10," ",STR_PAD_LEFT)?> 
<?=str_repeat(' ',28) . str_pad(number_format($luas_bng_sppt,0,',','.'),10," ",STR_PAD_LEFT)?> 
...
<?=str_repeat(' ',3) . 'DENDA ADMINISTRSI :Rp.' .number_format($denda_sppt,0,',','.')?> 
